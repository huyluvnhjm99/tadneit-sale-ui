...
class _ApiService implements ApiService {
  ...
  @override
  Future<AuthTokenDTO> refreshToken(RefreshTokenRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<UserProfileDTO> saveUserProfile(UserProfileDTO userProfileDTO) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(userProfileDTO.toJson());
    final _options = _setStreamType<UserProfileDTO>(
  ...
  @override
  Future<void> saveCategory(CategoryDTO categoryDTO) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(categoryDTO.toJson());
  ...
  @override
  Future<PageResponseDTO<ItemDTO>> getItemPaging(ItemFilter filter) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(filter.toJson());
    final _options = _setStreamType<PageResponseDTO<ItemDTO>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/i',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PageResponseDTO<ItemDTO> _value;
    try {
      _value = PageResponseDTO<ItemDTO>.fromJson(
        _result.data!,
  ...
  @override
  Future<String> getLink(String path) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<FileDTO> uploadFile(File file) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options = _setStreamType<FileDTO>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    late FileDTO _value;
    try {
      _value = FileDTO.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
